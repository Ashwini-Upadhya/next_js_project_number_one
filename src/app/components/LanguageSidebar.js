...
const LanguageSidebar = ({ services, activeService, setActiveService, serviceSubItems }) => {
  ...
  useEffect(() => {
    ...
    console.log(",serviceSubItems",serviceSubItems);
  ...
  return (
    <div>
      <h4 className="sidebar-header">Languages</h4>

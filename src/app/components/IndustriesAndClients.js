...
import Image1 from "../../assets/Images/industryImages/Industries_Served.png"
import Image2 from "../../assets/Images/industryImages/Clients_Feedback.png"
import Image3 from "../../assets/Images/industryImages/Case_Studies.png"
...
const IndustriesAndClients = () => {
  ...
  useEffect(() => {
    if (Object.keys(serviceUrlMapRef.current).length > 0) {
      ...
      if (normalizedKey && currentMap[normalizedKey]) {
        ...
        setActiveService("Industries Served");
      }
    }
  ...
  const handleServiceChange = (service) => {
    ...
    navigate(`/industriesandclients/${reverseServiceUrlMap[service]}`);
  };


  console.log('temContent', heroContent);
            ...
            <Col lg={6} className="text-white py-5">
              ...
              >
                <p className="mb-2">
                  ...
                  /{" "}
                  <Link to="/industriesandclients" className="text-white text-decoration-none">
        ...
        <Container fluid className="app-container" style={{ position: 'relative' }}>
          <Row>
            <Col md={4} sm={12} lg={4} xl={3} className="sidebar-col">
              <Sidebar 
              serviceSubItems={industrySubItems} 
            ...
            <Col md={8} sm={12} lg={8} xl={9}>
              <UnifiedMainContent activeService={activeService} key={activeService} services={industryServices} serviceUrlMapRef={serviceUrlMapRef} mediaEndpoint={'all-industries-and-clients'} />
            </Col>
          </Row>
        </Container>
      </div>
